...
function ShowCard({
  ...
  item: TvShowItem; focusKey: string; onArrow: (dir: string) => boolean; onSelect: () => void
}) {
  ...
  return (
    <FocusContext.Provider value={focusKey}>
      <div ref={ref} style={{ height: '100%', display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        ...
        {!loadingCats && (
          <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', paddingTop: 4, paddingBottom: 32 }}>
            {loadingShows ? (
              ...
              <div
                ref={scrollRef}
                style={{ flex: 1, overflowY: 'auto', overflowX: 'hidden', paddingLeft: '5vw', paddingRight: '5vw', paddingTop: 8 }}
                className="scrollbar-hide"
              >
